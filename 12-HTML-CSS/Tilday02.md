...
9. CSS 선택자(Selectors)
    ...
    * 상대 선택자
        - 앞에 나온 선택자 (A)로 선택된 HTML 요소를 기준으로, 뒤에 나온 선택자로 
          ...
          선택자 종류  
          1. 후손 선택자(`A B`) : A 선택자로 선택된 요소의 후손요소들 중에서 선택
          2. 자식 선택자(`A > B`) : A 선택자로 선택된 요소의 자식 요소들 중에서 선택
          3. 인접 형제 선택자(`A + B`) A선택자로 선택된 요소의 바로 다음에 나오는 형제 요소를 선택
          4. 일반 형제 선택자(`A ~ B`): A선택자로 선택된 요소의 다음에 나오는 형제 요소들중에서 선택
